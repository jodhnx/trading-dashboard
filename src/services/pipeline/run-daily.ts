    ...
    for (const user of users) {
      try {
        ...
        opportunityTotals = {
          ...
          signalReport: {
            liveAssets: opp.summary.signalReport.liveAssets,
            validSetups: opp.summary.signalReport.validSetups,
            watchCandidates: opp.summary.signalReport.watchCandidates,
            dataSkipped: opp.summary.signalReport.dataSkipped,
            skipReasons: opp.summary.signalReport.skipReasons,
            blockerAggregate: opp.summary.signalReport.blockerAggregate,
            rejectionReasons: opp.summary.signalReport.rejectionReasons,
            confirmationSimulation: opp.summary.signalReport.confirmationSimulation,
            whyNoSetup: opp.summary.signalReport.whyNoSetup,
            liveDiagnostics: opp.summary.signalReport.liveDiagnostics.map((d) => ({
              symbol: d.symbol,
...
function emptyOpportunities(): PipelineResult["opportunities"] {
  return {
    ...
    signalReport: {
      ...
      whyNoSetup: ["No opportunity scan has completed for this UTC day."],
      liveDiagnostics: [],
    },
    diagnosticsSample: [],
  };
